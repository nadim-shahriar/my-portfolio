...
export const Summary = () => {
  ...
  return (
    <div className="bg-[#1D1D1D] font2 text-sm p-20 text-white relative">
      <div>
      ...
      <button
        ...
        className="btn mt-4 text-white uppercase bg-transparent border-2 border-y-0 rounded-none  shadow-none"
      >
