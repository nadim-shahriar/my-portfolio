...
export const Summary = () => {
  ...
  useEffect(() => {
    updateHeight(); // when expand state changes
  }, [isExpanded]);

  return (
    <div
      className="bgImage bg-fixed font2 text-sm p-0 lg:p-20 text-white lg:text-black font-medium relative"
    ...
    >
      ...
      {/* Summary content */}
      <div className="bg-black/30 lg:bg-transparent p-10 lg:p-0">
